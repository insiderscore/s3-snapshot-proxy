...
- `allowlist.txt` selects object, conditional, ListObjects, ListObjectsV2, multi-object delete, versioned-object listing, basic multipart upload, explicit SSE-S3 upload, and overlay object tagging cases. Local regression tests cover origin-only object tagging through overlay facilitators.
