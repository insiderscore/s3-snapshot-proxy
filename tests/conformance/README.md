...
- `allowlist.txt` selects object, conditional, ListObjects, ListObjectsV2, multi-object delete, versioned-object listing, basic multipart upload, and explicit SSE-S3 upload cases.
